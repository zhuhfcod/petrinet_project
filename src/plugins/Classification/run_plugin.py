"""
This script is called by the plugin-wrapper, Classification.js, which passes down the
...
plugin = Classification(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
